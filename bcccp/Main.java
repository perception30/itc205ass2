		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					ISeasonTicket t1 = new SeasonTicket("a","Bathurst Chase", 1501641241962L, 1601641241962L);
					ISeasonTicket t2 = new SeasonTicket("b","Bathurst Chase", 1501641241962L, 1601641241962L);
